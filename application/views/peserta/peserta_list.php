<div class="content-wrapper">
    <section class="content">
        ...
        <?php echo anchor(site_url('peserta/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Tambah Data', 'class="btn btn-danger btn-sm"'); ?>
                    ...
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "nama_lengkap"},{"data": "nim"},{"data": "prodi"},{"data": "no_wa"},
                        {
                            "data" : "action",
                            "orderable": false,
