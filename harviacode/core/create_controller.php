...
$string .= "\n\n    public function index()
    {
        ...
        \$this->template->load('template_front','$c_url/$v_list', \$data);
    }";
...
$string .="\n\n    public function index()
    {
        \$this->template->load('template_front','$c_url/$v_list');
    } 
...
$string .= "\n\t    );
            \$this->template->load('template_front','$c_url/$v_read', \$data);
        } else {
...
$string .= "\n\t);
        \$this->template->load('template_front','$c_url/$v_form', \$data);
    }
